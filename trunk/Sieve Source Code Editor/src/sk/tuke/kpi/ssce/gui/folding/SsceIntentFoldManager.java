...
final class SsceIntentFoldManager implements FoldManager, Runnable {
    ...
    public static final FoldType INTENT_FOLD_TYPE = new FoldType("intent-fold"); // NOI18N
...
//    private HashMap intentFoldId = new HashMap();
...
//                if (mark.getId() != null)
//                    intentFoldId.put(mark.getId(), Boolean.valueOf(removedFold.isCollapsed())); // remember the last fold's state before remove
...
//                        Boolean collapsed = (Boolean)tagFoldId.get(matcher.group(2));
//                        if (collapsed != null)
...
//                }
    ...
    private final class FoldMarkInfo {
        ...
        private FoldMarkInfo(int startOffset,
                int endOffset, boolean collapsed, String description)
            ...
            if (fold == null) {
                try {
                    ...
                    fold = getOperation().addToHierarchy(
                            INTENT_FOLD_TYPE, getDescription(), collapsed,
...
//            System.out.println("\nHello Mattoke\n");
            return new SsceIntentFoldManager();
        }
    }
}
