...
final class SieveElementFoldManager implements FoldManager, Runnable {
    ...
    private static final Logger LOG = Logger.getLogger(SieveElementFoldManager.class.getName());
...
//    private HashMap tagFoldId = new HashMap();
    private static final RequestProcessor RP = new RequestProcessor(SieveElementFoldManager.class.getName());
